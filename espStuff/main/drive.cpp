...
void twistToMotorVels(std_msgs::Twist robotTwist, double* motorVels){
    motorVels[0] = - motorVels[2] = robotTwist.linear.y;
    motorVels[1] = - motorVels[3] = robotTwist.linear.x;
